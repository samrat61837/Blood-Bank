				...
				<div class="main-content">
										...
										<div class="table-responsive">
                                          ...
                                          <?php
												$id=$_SESSION['id'];
													...
													$stmt = $conn->prepare("SELECT * FROM tbl_user WHERE  user_bloodgroup = 'B +ve' ORDER BY  user_Firstname ASC"); 
													$stmt->execute();
													$sn=1;	
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body" >
											<div class="form-group">
												...
												<input type="hidden" name="returnback" value="Bpositive">
											<div >
                  ...
                  <div class="modal fade" id="mailModal<?php echo $v['user_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      ...
                      <input type="hidden" name="returnback" value="Bnegative">
