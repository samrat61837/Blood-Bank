				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							$stmt = $conn->prepare("SELECT * FROM tbl_user WHERE user_id='$id' " ); 
							$stmt->execute();
										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<?php if($user_data['user_photo'] == '') echo $default_photo; else echo $path.$user_data['user_photo']; ?>" />
												</span>
