							...
							<div class="col-xs-12">
								...
								<div class="container">
								   ...
								   <div class="form-group">
								    ...
								    <input type="hidden" name="bloodgroup" value="AB -ve">
										...
										<div class="table-responsive">
                                          ...
                                          <?php
												$id=$_SESSION['id'];
													...
													$stmt = $conn->prepare("SELECT * FROM tbl_user WHERE  user_bloodgroup = 'AB -ve'"); 
													$stmt->execute();
													$sn=1;	
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body" >
											<div class="form-group">
												...
												<input type="hidden" name="returnback" value="ABnegative">
