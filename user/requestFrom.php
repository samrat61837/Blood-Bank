...
<?php 
 include'layout_user/sidebar_user.php'; ?>
		...
		if(isset($_POST['reqbtn'])){
			...
			$to = 'prabinshresthanis111@gmail.com'; 
			$subject = 'Check for user Email';


			$message= 'blood Groop :'.$bg.'\n Date :'.$date1.'\n Location :'.$location1.'\n detail :'.$detail1;
			/*$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			$stmt = $conn->prepare("SELECT  user_Email FROM tbl_user Where bloodgroup="+$bg+" ;"); 
    		$stmt->execute();
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="infoform" id="infoform" method="POST" action="" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="date" placeholder="Time " name="date" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="Location" placeholder="location" name="Location" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea rows="10" cols="30" id="Details" name="Details">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" id="reqbtn" name="reqbtn" type="submit">
