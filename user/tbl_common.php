...
<?php include'layout_user/sidebar_user.php' ?>
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" onkeyup="search" name="email" id="email" placeholder="location" />
															<i class="icon-user"></i>
														</span>
													</label>
							...
							<!-- </div>
													<div class="col-xs-6"> <button type=" " name="btn" class="width-35 pull-right btn btn-sm btn-primary">
															<i class="icon-key"></i>
															search
														</button>
														</div>
 ...
 -->
								...
								<div class="row">
										...
										<div class="table-responsive">
                                          ...
                                          <?php
												$id=$_SESSION['id'];
													...
													$stmt = $conn->prepare("SELECT user_bloodgroup FROM tbl_user WHERE user_id=$id " ); 
													$stmt->execute();
													$user_bloodgroup=$stmt->fetch();
													$stmt = $conn->prepare("SELECT * FROM tbl_user WHERE user_bloodgroup = :bloodgroup" ); 
													 $stmt->bindParam(':bloodgroup', $user_bloodgroup['user_bloodgroup']);
													$stmt->execute();
													$sn=1;	
												...
												<tbody>
													<tr>
														...
														<td>
														<div align="center">
														<a href="" data-toggle="modal" data-target="#exampleModal<?php echo $v['user_id'] ?>">  <i class="fa fa-address-book" aria-hidden="true"> </i>
														</a></div>
														 <div align="center">
									...
									<!--SMS Modal -->
									<form name="" id="smsform<?php echo $v['user_id'] ?>"  method="POST" action="sa.php">
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body" >
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="num"  readonly placeholder="Username" value="977<?php echo $user_phone; ?>" class="col-xs-10 col-sm-5">

												</div>
											</div>

											<input type="hidden" name="returnback" value="tbl_common">
