...
$id='';
 // prepare sql and bind parameters
    $stmt = $conn->prepare("INSERT INTO tbl_category (cat_id, cat_title, cat_status) 
    VALUES (:cat_id, :cat_title, :cat_status)");
    $stmt->bindParam(':cat_id', $id);
    $stmt->bindParam(':cat_title', $title);
    $stmt->bindParam(':cat_status', $status);
	if($stmt->execute())
	{
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="" name="categoryform" id="categoryform">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="title"  id="title" placeholder="Category title" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<input  type="radio" name="status" value="active" checked class="ace" />
									<span class="lbl"> Active</span>
									

									<input  type="radio" name="status" value="inactive" class="ace" />
