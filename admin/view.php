...
$path = '../user/images/profile_photo/';
?>
										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="user's profile" src="<?php echo $path.$user_data['user_photo']; ?>"  />
												</span>
				...
				<div>
						...
						<form class="form-horizontal" name="infoform" id="infoform" method="POST" action="" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" disabled id="firstname" value="<?php echo $user_data['user_Firstname']?>" name="firstname" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" disabled id="middlename" value="<?php echo $user_data['user_Middlename']?>" name="middlename" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" disabled id="lastname" value="<?php echo $user_data['user_Lastname']?>" name="lastname" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="address" disabled value="<?php echo $user_data['user_Address']?>" name="address" class="col-xs-10 col-sm-5" />
										</div>
									</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="phonenumber" disabled value="<?php echo $user_data['user_phonenumber']?>" name="phonenumber" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Gender </label>
											<input  type="radio" name="gender" disabled value="male" <?php if($user_data['user_gender']=='male') echo 'checked'; ?> class="ace" />
									<span class="lbl">Male</span>
									

									<input  type="radio" name="gender" disabled value="female" <?php if($user_data['user_gender']=='female') echo 'checked'; ?> class="ace" />
									...
									<div class="col-sm-9">
											<input type="number" disabled id="age" value="<?php echo $user_data['user_age']?>" name="age" class="col-xs-10 col-sm-5" />
										</div>
									</div>
										...
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Available For Donation </label>
											<div class="col-sm-8">
											<input  type="radio" name="aviability" value="yes" disabled class="ace" <?php if($user_data['user_avialibility']=='yes') echo 'checked'; ?> />
											<span class="lbl">Yes</span>
									

											<input  type="radio" name="aviability" value="no" disabled class="ace" <?php if($user_data['user_avialibility']=='no') echo 'checked'; ?> />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Status </label>
											<input  type="radio" name="status" disabled value="yes"  class="ace" <?php if($user_data['user_status']=='yes') echo 'checked'; ?> />
											<span class="lbl">Active</span>
									

											<input  type="radio" name="status" disabled value="no" class="ace" <?php if($user_data['user_status']=='no') echo 'checked'; ?>/>
