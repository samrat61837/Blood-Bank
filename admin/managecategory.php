													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a href="editcategory.php?id=<?php echo $v['cat_id']; ?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="deletecategory.php?id=<?php echo $v['cat_id']; ?>" class="btn btn-xs btn-danger">
